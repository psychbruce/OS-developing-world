...
# tmp <- WorldData %>%
#       dplyr::filter(region %in% c("Serbia",'Kosovo'))
# # Merge Kosovo and Serbia, remove inner border
# serbia_and_kosovo_merged <- unionSpatialPolygons(ne_countries(scale=50, country=c("Kosovo","Republic of Serbia")), IDs = c(1, 1), threshold = 1.25)
# plot(serbia_and_kosovo_merged)
# 
# # Replace Serbia by the generated merged shape
# data[data$admin=="Republic of Serbia", "geometry"] <- st_as_sf(serbia_and_kosovo_merged)$geometry
